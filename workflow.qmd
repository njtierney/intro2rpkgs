...
(Note that this section is borrowed from my book, Quarto for Scientists: ["workflow"](https://qmd4sci.njtierney.com/workflow))
...
1. In RStudio, and run the following code to start a new rstudio project called "learned".
