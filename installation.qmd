...
In this section, the aim is to have everyone set up with R, RStudio, the tools you need to build an R package, and __git__.
...
## Software Setup: R + Friends

### Installing R

Install latest version of R [from CRAN](https://cran.rstudio.com)

![](images/clipboard-2422301126.png)
...
- Install latest version of RStudio Desktop from Posit [at this link](https://posit.co/download/rstudio-desktop/#download)

![](images/clipboard-2042210990.png)
...
:::{.callout-caution title = "Advanced: Personalising your R Profile" collapse="true"}
...
── dev package ─────────────────────────────────────────────────────────────────────────────
• package: 'rpkgintro'
• path: '/Users/nick_1/github/njtierney/rpkg-intro/'
