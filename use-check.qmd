...
The reason is that sometimes as we fix things, we sometimes break things more. If we are just trying to fix one thing at a time, then we can know that any changes we made are more directly tied to that new issue.

As you get more experienced, you will understand how to fix problems faster, and how to fix multiple things. 
...
The error occurs because the example code, `praise()`, needs an argument in order to work. Fix it by adding an argument:
