...
You can think of roxygen as being like really special comments - notice that they are really similar to R comments! It's just `#` with a single quote, `'`. You can then add special labels with `@`. In our case, we will just look at the ones that were created with the insert roxygen skeleton helper. We will look at more of these soon.
