...
(This section is also in my other book, ["Quarto for Scientists"](https://qmd4sci.njtierney.com/rstudio.html))
...
![Setting the options right for RStudio, so you don't restore previous sessions work, and don't save it either.](figs/rstudio-remove-data.png)
